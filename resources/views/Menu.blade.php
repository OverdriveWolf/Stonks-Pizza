...
@section('content')
    ...
    <div class="min-h-screen flex flex-col">
        <!-- Header -->
        <header class="bg-blue-800 text-white p-4 text-center text-xl font-bold">Orders</header>
        <hr>

        <main class="p-8 flex flex-col lg:flex-row gap-8">

            <!-- Order Form -->
            <form action="{{ route('winkelwagentje.store') }}" method="POST"
                ...
                <div class="pizza-grid">
                    @foreach ($pizzas as $pizza)
                        ...
                        <label class="pizza-card cursor-pointer">
                            <input type="radio" name="selected_pizza" value="{{ $pizza->id }}"
                ...
                <div class="mb-4">
                    <label class="block font-medium">place of residence</label>
                ...
                <div class="mb-4">
                    <label class="block font-medium">Phonenumber</label>
